...
//Components
import ExpCard from "./create_profile/experience_profile_array";
import BestWorkCard from "./create_profile/bestwork_profile_obj";
import ProfileArray from "./create_profile/licences_profile_array";
...
class CreateProfile extends Component {
  ...
  render() {
    ...
    let { classifcations, workstatus, worktype } = this.state;
    return (
      <div>
