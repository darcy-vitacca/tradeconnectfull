...
//  TODO: CREATE PROFILE BUG
  ...
  renderMarkup() {
    ...
    let {  about,
      ...
      console.log(this.props.user.profile.workStatus)
    let workStatusDot = this.props.user.profile.workStatus === "Not Looking for Work Currently But In the Future" ?("dotOrange"):(this.props.user.profile.workStatus === "Currently Employed"?("dotRed"):("dot"))
